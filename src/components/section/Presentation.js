...
function Presentation(){
    return(
      <div className={styles.presentation} id='Presentation'>
        ...
        Ao passar do tempo, entendi que não apenas o programa precisa ser estruturado, mas o processo como um todo, desde a primeira <br/>
        informação, ou seja, o problema a ser solucionado, e com isso, me aprofundei mais em Análises de dados e Desenvolvimento de Sistemas.<br/>
