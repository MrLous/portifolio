...
function Presentation(){
    return(
      <div className={styles.presentation} id='Presentation'>
        ...
        Comecei a trabalhar ainda com 15 anos na Industria metalúrgica, me tornei mais organizado e passei a planejar as tarefas conseguindo melhorar meus projetos e otimizando as entregas. Passei de menor aprendiz para auxiliar, estoquista, coordenador de estoque e comprador.<br/>
